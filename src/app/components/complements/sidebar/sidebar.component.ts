					...
					if (parent3El && parent3El.id !== 'side-menu') {
						...
						if (parent4El && parent4El.id !== 'side-menu') {
							...
							if (parent5El && parent5El.id !== 'side-menu') {
								...
								const child_anchor = parent5El.querySelector('.is-parent');
								if (child_anchor && parent5El.id !== 'side-menu') {
									child_anchor.classList.add('mm-active');
								}
							}
						}
					}
